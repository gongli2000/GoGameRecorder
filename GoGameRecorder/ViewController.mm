...
@interface ViewController (delegate) <SBApplicationDelegate>
@end
...
-(IBAction) doMailSGF:(id)sender{
    [self sendEmailMessage:sender
        subject:@"subject"
        sender:@"larrye2000@gmail.com"
        to:@"larrye2000@gmail.com"
        content:@"dfdfdf"
                attachment:@""];
}

- (IBAction)sendEmailMessage:(id)senderx
